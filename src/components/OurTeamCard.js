    ...
    return (
            <div className="text-center">
                ...
                <div className="my-2 d-flex align-items-center justify-content-center">
                    ...
                    <a className="me-2" style={{color: "black" ,padding: "10px"}} href="https://www.linkedin.com/in/siddharth25pandey/"><i class="fa-brands fa-linkedin fa-2x"></i></a>
                    </div>
                    <div style={{margin: "5px"}}>
                    <a className="me-2" style={{color: "black"}} href="https://github.com/siddharth25pandey"><i className="fa-brands fa-github fa-2x"></i
                    ></a>
                </div>
                </div>
                </div>
