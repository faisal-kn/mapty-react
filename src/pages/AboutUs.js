...
function Aus() {
  return (
    <div>
        <TwoCards h1="ABOUT US" h2="Event Organiser platform" buttxt="Share Event" link="https://media.istockphoto.com/vectors/group-of-programmers-work-together-vector-id623897990"
